...
const { authenticate, authenticateReset } = require('../middleware/authentication.js')
...
router.post('/reset-password/:id', authenticateReset,validation.resetPassword, controllers.resetPassword)
